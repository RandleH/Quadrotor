...
extern uint8_t (*DMP_API_I2C_WriteDMP_Handle)(uint8_t,uint8_t,uint8_t,unsigned char*);
extern uint8_t (*DMP_API_I2C_ReadDMP_Handle)(uint8_t,uint8_t ,uint8_t,unsigned char*);
extern void (*API_DELAY_ms_Handle)(uint32_t);
extern void (*API_DELAY_us_Handle)(uint32_t);



#define i2c_write   (*DMP_API_I2C_WriteDMP_Handle)
#define i2c_read    (*DMP_API_I2C_ReadDMP_Handle)


#define delay_ms    (*API_DELAY_ms_Handle)          //CPU_TS_Tmr_Delay_MS
#define get_ms      my_delay_ms
